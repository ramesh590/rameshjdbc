	...
	public class SelectDataDemo {
	    public static void main(String[] args) {
	        ...
	        try
	        {
	            ...
	            ResultSet rs = selectStmt.executeQuery("SELECT CID,CNAME FROM CUSTOMER WHERE CID = 102");
	            while(rs.next())
	            {
               System.out.println(rs.getInt("CID"));    //First Column
	                System.out.println(rs.getString("CNAME"));    //Second Column
